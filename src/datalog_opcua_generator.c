...
#define view_ATTS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  \
    SET_CONT_NO_LOOPS(view)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        \
    SET_EVENT_NOTIFIER(view)

#define BASE_NODE(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            \
    SET_PARENT_ID_NS(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         \
...
#define SET_BROWSE_NAME(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      \
    DL_OPCUA_ERR_t self_set_##TYPE##_browse_name(opcua_##TYPE##_t* self, char* browse_name)                                                                                                                                                                                                                                                                                                                                                                                                                        \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        DL_OPCUA_ERR_t ret = datalog_opcua_set_browse_name(self->attributes, browse_name);                                                                                                                                                                                                                                                                                                                                                                                                                         \
        return ret;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \
    }

#define SET_DISPLAY_NAME(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
    DL_OPCUA_ERR_t self_set_##TYPE##_display_name(opcua_##TYPE##_t* self, char* display_name)                                                                                                                                                                                                                                                                                                                                                                                                                      \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        DL_OPCUA_ERR_t ret = datalog_opcua_set_display_name(self->attributes, display_name);                                                                                                                                                                                                                                                                                                                                                                                                                       \
        return ret;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \
    }

#define SET_DESCRIPTION(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      \
...
#define SET_U_WRITE_MASK(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
    DL_OPCUA_ERR_t self_set_##TYPE##_user_write_mask(opcua_##TYPE##_t* self, int ual)                                                                                                                                                                                                                                                                                                                                                                                                                              \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
...
#define SET_WRITE_MASK(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
    DL_OPCUA_ERR_t self_set_##TYPE##_write_mask(opcua_##TYPE##_t* self, int al)                                                                                                                                                                                                                                                                                                                                                                                                                                    \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        if (self->attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
...
#define SET_IS_ABSTRACT(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      \
    DL_OPCUA_ERR_t self_set_##TYPE##_is_abstract(opcua_##TYPE##_t* self, bool abstract)                                                                                                                                                                                                                                                                                                                                                                                                                            \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        if (self->TYPE##_attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
...
#define SET_VALUE(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            \
    DL_OPCUA_ERR_t self_set_##TYPE##_value(opcua_##TYPE##_t* self, void* value)                                                                                                                                                                                                                                                                                                                                                                                                                                    \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        /*TODO*/                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
        return DL_OPCUA_OK;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        \
    }

#define SET_DATA_TYPE(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        \
    DL_OPCUA_ERR_t self_set_##TYPE##_data_type(opcua_##TYPE##_t* self, char* ID)                                                                                                                                                                                                                                                                                                                                                                                                                                   \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        /*TODO*/                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
        return DL_OPCUA_OK;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        \
    }

#define SET_VALUE_RANK(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
    DL_OPCUA_ERR_t self_set_##TYPE##_value_rank(opcua_##TYPE##_t* self, int32_t vr)                                                                                                                                                                                                                                                                                                                                                                                                                                \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        if (self->TYPE##_attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
...
#define SET_ARRAY_DIM(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        \
    DL_OPCUA_ERR_t self_set_##TYPE##_array_dimensions(opcua_##TYPE##_t* self, uint32_t ad)                                                                                                                                                                                                                                                                                                                                                                                                                         \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        if (self->TYPE##_attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
...
#define SET_ACCESS_LEVEL(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
    DL_OPCUA_ERR_t self_set_##TYPE##_access_level(opcua_##TYPE##_t* self, unsigned char al)                                                                                                                                                                                                                                                                                                                                                                                                                        \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        if (self->TYPE##_attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
...
#define SET_U_ACCESS_LEVEL(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
    DL_OPCUA_ERR_t self_set_##TYPE##_user_access_level(opcua_##TYPE##_t* self, unsigned char ual)                                                                                                                                                                                                                                                                                                                                                                                                                  \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        if (self->TYPE##_attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
...
#define SET_MIN_SAMP_INT(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
    DL_OPCUA_ERR_t self_set_##TYPE##_min_samp_interval(opcua_variable_t* self, double msi)                                                                                                                                                                                                                                                                                                                                                                                                                         \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        if (self->variable_attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
        self->variable_attributes->min_samp_interval = msi;                                                                                                                                                                                                                                                                                                                                                                                                                                                        \
        return DL_OPCUA_OK;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        \
    }

#define SET_HISTORIZING(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      \
    DL_OPCUA_ERR_t self_set_##TYPE##_historizing(opcua_variable_t* self, bool hist)                                                                                                                                                                                                                                                                                                                                                                                                                                \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        if (self->variable_attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
...
#define SET_DEC_ID(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
    DL_OPCUA_ERR_t self_set_##TYPE##_declaration_id(opcua_##TYPE##_t* self, int id)                                                                                                                                                                                                                                                                                                                                                                                                                                \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        if (self->TYPE##_attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
...
#define SET_EXECUTABLE(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
    DL_OPCUA_ERR_t self_set_##TYPE##_execuatble(opcua_##TYPE##_t* self, bool val)                                                                                                                                                                                                                                                                                                                                                                                                                                  \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        if (self->TYPE##_attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
...
#define SET_U_EXECUTABLE(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
    DL_OPCUA_ERR_t self_set_##TYPE##_user_execuatble(opcua_##TYPE##_t* self, bool val)                                                                                                                                                                                                                                                                                                                                                                                                                             \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        if (self->TYPE##_attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
...
#define SET_EVENT_NOTIFIER(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
    DL_OPCUA_ERR_t self_set_##TYPE##_event_notifier(opcua_##TYPE##_t* self, unsigned char event_notifier)                                                                                                                                                                                                                                                                                                                                                                                                          \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        if (self->TYPE##_attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
...
//## REFERENCE TYPE
#define SET_SYMMETRIC(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        \
    DL_OPCUA_ERR_t self_set_##TYPE##_symmetric(opcua_##TYPE##_t* self, bool symmetric)                                                                                                                                                                                                                                                                                                                                                                                                                             \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        if (self->TYPE##_attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
...
#define SET_INVERSE_NAME(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
    DL_OPCUA_ERR_t self_set_##TYPE##_inverse_name(opcua_##TYPE##_t* self, char* inverse_name)                                                                                                                                                                                                                                                                                                                                                                                                                      \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        if (self->TYPE##_attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
        if (inverse_name == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
        self->TYPE##_attributes->inverse_name = (char*)realloc(self->TYPE##_attributes->inverse_name, sizeof(char) * (strlen(inverse_name) + 1));                                                                                                                                                                                                                                                                                                                                                                  \
        if (self->TYPE##_attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
            return DL_OPCUA_MEM;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
...
//## VIEW
#define SET_CONT_NO_LOOPS(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
    DL_OPCUA_ERR_t self_set_##TYPE##_contains_no_loops(opcua_##TYPE##_t* self, bool val)                                                                                                                                                                                                                                                                                                                                                                                                                           \
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        if (self->TYPE##_attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
...
#define CREATE_XML_NODE(TYPE, LABEL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
    ...
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        ...
        if (object->attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                            \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
        if (object->TYPE##_attributes == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
            return DL_OPCUA_INVAL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
        DL_OPCUA_ERR_t ret = DL_OPCUA_OK;                                                                                                                                                                                                                                                                                                                                                                                                                                                                          \
        object->node = xmlNewChild(opcua_document->root_node, NULL, BAD_CAST #LABEL, NULL);                                                                                                                                                                                                                                                                                                                                                                                                                        \
        ret = datalog_opcua_create_node_attributes(object->node, object->display_name_node, object->attributes);                                                                                                                                                                                                                                                                                                                                                                                                   \
        if (ret != DL_OPCUA_OK)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
            return DL_OPCUA_ATTR;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  \
...
// SERVER CONFIG
opcua_reference_t object_type_array[] = { { .type = "HasSubtype", .id = { .i = 58 }, .is_forward = false }, { .type = "HasComponent", .id = { .i = 6001, .ns = 1 }, .is_forward = -1 }, { .type = "HasComponent", .id = { .i = 7001, .ns = 1 }, .is_forward = -1 }, { .type = "HasComponent", .id = { .i = 6002, .ns = 1 }, .is_forward = -1 }, { .type = "HasComponent", .id = { .i = 5001, .ns = 1 }, .is_forward = -1 }, { .type = "HasComponent", .id = { .i = 7006, .ns = 1 }, .is_forward = -1 },
    { .type = "HasComponent", .id = { .i = 6037, .ns = 1 }, .is_forward = -1 }, { .type = "HasComponent", .id = { .i = 6035, .ns = 1 }, .is_forward = -1 }, { .type = NULL } };
...
{
    xmlSaveFormatFileEnc(opcua_document->filename, opcua_document->document, "UTF-8", 1);
...
DL_OPCUA_ERR_t datalog_opcua_init_doc(void)
{
    ...
    opcua_document = datalog_opcua_create_document(XML_FILENAME, XML_FILE_VERSION);

    xmlCreateIntSubset(opcua_document->document, BAD_CAST "UANodeSet", NULL, BAD_CAST "dtdIsHere");

    tmp_node = xmlNewChild(opcua_document->root_node, NULL, BAD_CAST "NamespaceUris", NULL);
    ...
    tmp_parent = xmlNewChild(opcua_document->root_node, NULL, BAD_CAST "Extensions", NULL);
...
{
    self->type = (char*)realloc(self->type, sizeof(char) * (strlen(type) + 1));
    if (self->type == NULL)
        return DL_OPCUA_MEM;
...
//##ATTRIBUTE
DL_OPCUA_ERR_t self_set_attribute_parent_node_id_ns(opcua_node_attributes_t* self, int ns)
{
...
DL_OPCUA_ERR_t self_set_attribute_parent_node_id_s(opcua_node_attributes_t* self, char* s)
{
...
DL_OPCUA_ERR_t self_set_attributes_node_browse_name(opcua_node_attributes_t* self, char* browse_name)
{
    DL_OPCUA_ERR_t ret = datalog_opcua_set_browse_name(self, browse_name);
    return ret;
}

DL_OPCUA_ERR_t self_set_attributes_node_display_name(opcua_node_attributes_t* self, char* display_name)
{
    DL_OPCUA_ERR_t ret = datalog_opcua_set_display_name(self, display_name);
    return ret;
}

DL_OPCUA_ERR_t self_set_attribute_description(opcua_node_attributes_t* self, char* description)
{
    DL_OPCUA_ERR_t ret = datalog_opcua_set_description(self, description);
    return ret;
}

DL_OPCUA_ERR_t self_set_attribute_user_write_mask(opcua_node_attributes_t* self, int ual)
{
...
DL_OPCUA_ERR_t datalog_opcua_set_browse_name(opcua_node_attributes_t* attribute, char* browse_name)
{
    attribute->browse_name = (char*)realloc(attribute->browse_name, sizeof(char) * (strlen(browse_name) + 1));
...
DL_OPCUA_ERR_t datalog_opcua_set_display_name(opcua_node_attributes_t* attribute, char* display_name)
{
    attribute->display_name = (char*)realloc(attribute->display_name, sizeof(char) * (strlen(display_name) + 1));
...
{
    if (value != NULL) {
        id->s = (char*)realloc(id->s, sizeof(char) * (strlen(value) + 1));
        if (id->s == NULL)
            return DL_OPCUA_MEM;
        strcpy(id->s, value);
        return DL_OPCUA_OK;
...
{
    if (o != NULL) {
        id->o = (char*)realloc(id->o, sizeof(char) * (strlen(o) + 1));
        if (id->o == NULL)
            return DL_OPCUA_MEM;
        strcpy(id->o, o);
        return DL_OPCUA_OK;
...
{
    if (g != NULL) {
        id->g = (char*)realloc(id->g, sizeof(char) * (strlen(g) + 1));
        if (id->g == NULL)
            return DL_OPCUA_MEM;
        strcpy(id->g, g);
        return DL_OPCUA_OK;
...
DL_OPCUA_ERR_t datalog_opcua_set_description(opcua_node_attributes_t* attribute, char* description)
{
    attribute->description = (char*)realloc(attribute->description, sizeof(char) * (strlen(description) + 1));
...
// CREATE OBJECT NODES
// ATTRIBUTES
DL_OPCUA_ERR_t datalog_opcua_create_node_attributes(xmlNodePtr node, xmlNodePtr display_name_node, opcua_node_attributes_t* attributes)
{
    char buffer[32];

    DL_OPCUA_ERR_t ret = datalog_opcua_add_id_attribute(node, "ParentNodeId", &attributes->parent_node_id);
    if (ret != DL_OPCUA_OK)
        return DL_OPCUA_ATTR;

    ret = datalog_opcua_add_id_attribute(node, "NodeId", &attributes->node_id);
    if (ret != DL_OPCUA_OK)
        return DL_OPCUA_ATTR;

    if (attributes->browse_name != NULL)
        xmlNewProp(node, BAD_CAST "BrowseName", BAD_CAST attributes->browse_name);

    if (display_name_node == NULL) {
        if (attributes->display_name != NULL)
            display_name_node = xmlNewChild(node, NULL, BAD_CAST "DisplayName", BAD_CAST attributes->display_name);
    } else
        xmlNodeSetContent(display_name_node, BAD_CAST attributes->display_name);
...
DL_OPCUA_ERR_t datalog_opcua_create_node_object_type_attributes(opcua_object_type_t* object_t)
{
    char buffer[32];
    ...
    if (object_t->object_type_attributes->is_abstract != -1) {
        sprintf(buffer, "%s", (object_t->object_type_attributes->is_abstract == true ? "true" : "false"));
...
DL_OPCUA_ERR_t datalog_opcua_create_node_variable_attributes(opcua_variable_t* variable)
{
    ...
    DL_OPCUA_ERR_t ret = datalog_opcua_add_id_attribute(variable->node, "DataType", &variable->variable_attributes->data_type);
    if (ret != DL_OPCUA_OK)
        return DL_OPCUA_ATTR;
...
DL_OPCUA_ERR_t datalog_opcua_create_node_variable_type_attributes(opcua_variable_type_t* variable_type)
{
    char buffer[32];

    // TODO value

    DL_OPCUA_ERR_t ret = datalog_opcua_add_id_attribute(variable_type->node, "DataType", &variable_type->variable_type_attributes->data_type);
    if (ret != DL_OPCUA_OK)
        return DL_OPCUA_ATTR;
    ...
    if (variable_type->variable_type_attributes->is_abstract != -1) {
        sprintf(buffer, "%s", (variable_type->variable_type_attributes->is_abstract == true ? "true" : "false"));
...
DL_OPCUA_ERR_t datalog_opcua_create_node_reference_type_attributes(opcua_reference_type_t* reference_type)
{
    char buffer[32];

    if (reference_type->reference_type_attributes->is_abstract != -1) {
        sprintf(buffer, "%s", (reference_type->reference_type_attributes->is_abstract == true ? "true" : "false"));
    ...
    if (reference_type->reference_type_attributes->symmetric != -1) {
        sprintf(buffer, "%s", (reference_type->reference_type_attributes->symmetric == true ? "true" : "false"));
    ...
    if (reference_type->reference_type_attributes->inverse_name != NULL)
        xmlSetProp(reference_type->node, BAD_CAST "InverseName", BAD_CAST reference_type->reference_type_attributes->inverse_name);

    return DL_OPCUA_OK;
}

DL_OPCUA_ERR_t datalog_opcua_create_node_data_type_attributes(opcua_data_type_t* data_type)
{
    char buffer[32];

    if (data_type->data_type_attributes->is_abstract != -1) {
        sprintf(buffer, "%s", (data_type->data_type_attributes->is_abstract == true ? "true" : "false"));
...
DL_OPCUA_ERR_t datalog_opcua_create_node_view_attributes(opcua_view_t* view)
{
    char buffer[32];

    if (view->view_attributes->contains_no_loops != -1) {
        sprintf(buffer, "%s", (view->view_attributes->contains_no_loops == true ? "true" : "false"));
...
// OBJECTS
DL_OPCUA_ERR_t datalog_opcua_create_node_object_type_from_array(opcua_reference_t* array, opcua_node_attributes_t* attributes)
{
    int i = 0;
    ...
    if (tmp_obj_type->attributes != NULL) {
        memcpy(&tmp_obj_type->attributes->node_id, &attributes->node_id, sizeof(opcua_node_id_t));
        memcpy(&tmp_obj_type->attributes->parent_node_id, &attributes->parent_node_id, sizeof(opcua_node_id_t));
    }
...
opcua_reference_t* datalog_opcua_find_reference_i(void* object, DL_OPCUA_TYPE_t type, int i)
{
...
opcua_reference_t* datalog_opcua_find_reference_s(void* object, DL_OPCUA_TYPE_t type, char* s)
{
    opcua_reference_t* ref_head;
...
opcua_reference_t* datalog_opcua_find_reference_type(void* object, DL_OPCUA_TYPE_t type, char* type_string)
{
    opcua_reference_t* ref_head;
...
opcua_reference_t* datalog_opcua_find_reference(void* object, DL_OPCUA_TYPE_t type, opcua_node_id_t* ID)
{
    opcua_reference_t* ref_head;
...
DL_OPCUA_ERR_t datalog_opcua_free_reference_list(void** object, DL_OPCUA_TYPE_t type)
{
...
#define TYPE_CAST_SWITCH_REF_HEAD_ADD_REF(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
    case DL_OPC_##TYPE:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            \
        if (((opcua_##TYPE##_t*)object)->reference_head == NULL) {                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
            ...
            opcua_reference_t* ref_head = ((opcua_##TYPE##_t*)object)->reference_head;                                                                                                                                                                                                                                                                                                                                                                                                                             \
...
DL_OPCUA_ERR_t datalog_opcua_add_reference(opcua_reference_t* reference, void* object, DL_OPCUA_TYPE_t object_type)
{
    switch (object_type) {
...
DL_OPCUA_ERR_t datalog_opcua_add_reference_attributes(xmlNodePtr reference_node, opcua_reference_t* reference)
{
    char buffer[32];

    if (reference->type != NULL)
        xmlNewProp(reference_node, BAD_CAST "ReferenceType", BAD_CAST reference->type);
...
#define XML_REFERENCE_SWITCH(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
    case DL_OPC_##TYPE:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            \
        ...
        if (((opcua_##TYPE##_t*)object)->references_node == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                  \
            ((opcua_##TYPE##_t*)object)->references_node = xmlNewChild(((opcua_##TYPE##_t*)object)->node, NULL, BAD_CAST "References", NULL);                                                                                                                                                                                                                                                                                                                                                                      \
        if (((opcua_##TYPE##_t*)object)->references_node != NULL) {                                                                                                                                                                                                                                                                                                                                                                                                                                                \
            if (((opcua_##TYPE##_t*)object)->reference_head != NULL) {                                                                                                                                                                                                                                                                                                                                                                                                                                             \
                opcua_reference_t* ref_head = ((opcua_##TYPE##_t*)object)->reference_head;                                                                                                                                                                                                                                                                                                                                                                                                                         \
                while (ref_head != NULL) {                                                                                                                                                                                                                                                                                                                                                                                                                                                                         \
                    xmlNodePtr tmp_node = xmlNewChild(((opcua_##TYPE##_t*)object)->references_node, NULL, BAD_CAST "Reference", NULL);                                                                                                                                                                                                                                                                                                                                                                             \
...
{
    if ((*attribute)->browse_name != NULL)
        free((*attribute)->browse_name);
    if ((*attribute)->display_name != NULL)
        free((*attribute)->display_name);
    if ((*attribute)->description != NULL)
        free((*attribute)->description);
    return DL_OPCUA_OK;
}

void datalog_opcua_free_object_type_attributes(opcua_object_type_attributes_t** attribs)
{
...
void datalog_opcua_free_method_attributes(opcua_method_attributes_t** attribs)
{
...
void datalog_opcua_free_variable_attributes(opcua_variable_attributes_t** attribs)
{
...
void datalog_opcua_free_object_attributes(opcua_object_attributes_t** attribs)
{
...
void datalog_opcua_free_variable_type_attributes(opcua_variable_type_attributes_t** attribs)
{
    // TODO WHEN VALUE IS DONE
    free(*attribs);
    *attribs = NULL;
}

void datalog_opcua_free_reference_type_attributes(opcua_reference_type_attributes_t** attribs)
{
...
void datalog_opcua_free_data_type_attributes(opcua_data_type_attributes_t** attribs)
{
...
void datalog_opcua_free_view_attributes(opcua_view_attributes_t** attribs)
{
...
DL_OPCUA_ERR_t datalog_opcua_add_id_attribute(xmlNodePtr node, char* attribute, opcua_node_id_t* id)
{
    char buffer[32];
...
{
    opcua_node_attributes_t* ret = (opcua_node_attributes_t*)calloc(1, sizeof(opcua_node_attributes_t));
    if (ret == NULL)
        return NULL;
...
#define CREATE_OBJECT_ATTRIBUTES(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                             \
    ...
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        opcua_##TYPE##_attributes_t* ret = (opcua_##TYPE##_attributes_t*)calloc(1, sizeof(opcua_##TYPE##_attributes_t));                                                                                                                                                                                                                                                                                                                                                                                           \
        if (ret == NULL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
            return NULL;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
        return ret;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \
    }
...
#define CREATE_OBJECT(TYPE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        \
    ...
    {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
        ...
        TYPE##_CREATE_OBJECT return ret;                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
    }
...
{
    opcua_reference_t* ret = (opcua_reference_t*)calloc(1, sizeof(opcua_reference_t));
    if (ret == NULL)
        return NULL;
...
DL_OPCUA_ERR_t datalog_opcua_create_attach_reference(opcua_reference_t* reference_head, char* parent_ID, char* target_ID, char* type, bool is_forward)
{
...
DL_OPCUA_ERR_t datalog_opcua_create_attach_reference_head(opcua_reference_t** ref_head, char* parent_ID, char* target_ID, char* type, bool is_forward)
{
    (*ref_head) = (opcua_reference_t*)calloc(1, sizeof(opcua_reference_t));
    if ((*ref_head) == NULL)
        return DL_OPCUA_MEM;
...
char* datalog_opcua_parse_id_s(char* id)
{
    ...
    while (token) {
        if (token[0] == 's') {
            char* ret = (char*)malloc(sizeof(char) * (strlen(token + 2) + 1));
            if (ret == NULL)
                return NULL;
            strcpy(ret, token + 2);
            return ret;
