...
#define FOR_EACH_TYPE_W_LABEL(FUNC)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \
    FUNC(object_type, UAObjectType)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \
...
#define object_type_CREATE_STRUCT DL_OPCUA_ERR_t (*set_is_abstract)(opcua_object_type_t*, bool);
...
#define object_CREATE_STRUCT DL_OPCUA_ERR_t (*set_event_notifier)(opcua_object_t*, unsigned char);
...
#define data_type_CREATE_STRUCT DL_OPCUA_ERR_t (*set_is_abstract)(opcua_data_type_t*, bool);
...
#define OBJECT_STRUCT(TYPE, LABEL)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
    ...
    struct opcua_##TYPE {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          \
        ...
        DL_OPCUA_ERR_t (*add_reference)(opcua_##TYPE##_t*, opcua_reference_t*); /**< Adds a reference object to the object's references linked list*/                                                                                                                                                                                                                                                                                                                                                              \
 ...
 * @return DL_OPCUA_ERR_t error message
 */
DL_OPCUA_ERR_t datalog_opcua_add_reference_attributes(xmlNodePtr references_node, opcua_reference_t* reference);
...
#define FREE_OBJECT_PROTO(TYPE) DL_OPCUA_ERR_t datalog_opcua_free_##TYPE(opcua_##TYPE##_t** TYPE);
